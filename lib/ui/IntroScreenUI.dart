  ...
  void initState() {
    ...
    pageDecoration = PageDecoration(
      titleTextStyle: GoogleFonts.metrophobic(
          fontSize: Constant.size28,
          fontWeight: FontWeight.w700,
          color: AppColors.white),
      bodyTextStyle: GoogleFonts.metrophobic(
          fontSize: Constant.size16, color: AppColors.primaryColor),
      descriptionPadding: EdgeInsets.fromLTRB(
          Constant.size16, Constant.size16, Constant.size16, Constant.size16),
                      ...
                      dotsDecorator: DotsDecorator(
                        ...
                        activeShape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.all(
                              Radius.circular(Constant.size24)),
                        ),
                      ),
                    ),
                  ),
...
void _onIntroEnd(
    context, preferenceHelper, CommonEditorController commonEditorController) {
...
Widget _buildImage(String assetName) {
  return Align(
    child: Container(
        ...
        child: Image.asset(AppString.imagesAssetPath + '$assetName.png',
            width: 350.0)),
