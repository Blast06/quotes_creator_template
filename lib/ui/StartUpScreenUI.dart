...
import 'package:thoughts_creator/controller/AdmobController.dart';
                    ...
                    children: [
                      InkWell(
                          ...
                          child: Icon(
                            ...
                            color: AppColors.primaryColor,
                            size: Constant.size40,
                          )),
                      InkWell(
                          onTap: () {
                            StoreRedirect.redirect(
                                androidAppId: AppString.appId, iOSAppId: '');
                          },
                          child: Icon(
                ...
                Container(
                  ...
                  child: new Row(
                    ...
                    children: [
                      Container(
                        margin: EdgeInsets.only(
                            left: Constant.size10, right: Constant.size20),
                      ...
                      Container(
                        ...
                        style: GoogleFonts.saira(
                            fontSize: 16.0, color: AppColors.textDisableColor),
                      )),
                      Container(
                        margin: EdgeInsets.only(
                            left: Constant.size20, right: Constant.size10),
                        color: AppColors.textDisableColor,
                        height: 1,
                        width: 50.0,
                      ),
                ...
                Container(
                  ...
                  child: new Row(
                    ...
                    children: [
                      InkWell(
                          onTap: () {
                            AppCommonFunc.launchSocialUrl(
                                AppString.socialFbRain);
                          },
                          child: Icon(
