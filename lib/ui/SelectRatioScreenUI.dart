                              ...
                              return ListView(
                                children: [
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          ...
                                          child: WidgetRatioSelectController(
                                              ...
                                              onPressed: () {
                                                ratioController
                                                    .updateSelectedRatioContainer(
                                                        0);
                                                ratioController
                                                    .updateRatioValue(
                                                        9.0, 16.0);
                                                ratioController
                                                    .setTextMatrixPointCenter(
                                                        ValueNotifier(Matrix4
                                                                .identity())
                                                            .value);
                                                ...
                                                if (commonController
                                                  ...
                                                  ratioController
                                                      .updateRatioValue(
                                                          9.0, 16.0);
                                                  commonController
                                                      .updateImageBgPath(AppString
                                                          .NoApiImageNetwork);
                                                } else {
                                                  commonController
                                                      .updateBgImgRatioResponse(
                                                          commonController
                                                              .getBgImageResponse
                                                              .data
                                                              .size
                                  ...
                                  Container(
                                    ...
                                    margin:
                                        EdgeInsets.only(top: Constant.size15),
                                    child: new Row(
                                      mainAxisAlignment:
                                          MainAxisAlignment.spaceEvenly,
                                      crossAxisAlignment:
