...
class SliderPreviewImageUI extends StatefulWidget {
  ...
  final List<Images> _popularImgList;
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            bottom: Constant.size20, top: Constant.size10),
                        child: InkWell(
                          onTap: () async {
                            ...
                            if (!widget.isPopular) {
                              ...
                              final file =
                                  File(documentDirectory.path + "/" + filename);
                        ...
                        child: widget.isPopular
                            ? Image.network(
                                ...
                                errorBuilder: (BuildContext context,
                                  ...
                                  return AppCommonFunc.defaultErrorWidget(
                                      context, 300.0, 300.0);
                                },
                              )
                            : Image.file(
