...
class _MainScreenUIState extends State<MainScreenUI> {
  ...
  String title = 'app_bar_title_1'.tr;
    ...
    SharedPreferences.getInstance().then((SharedPreferences sp) {
      ...
      Future.delayed(new Duration(seconds: 1), () async {
        if (commonController.isNoDataApi) {
          ...
          commonController
              .updateBgImgRatioResponse(commonController.sizeRatioBgImage);
        } else {
          ...
          child: GetBuilder(
              ...
              builder: (
                ...
                return Scaffold(
                  ...
                  drawer: AppCommonFunc.appDrawer(
                      context, _scaffoldKey, commonEditorController),
                  appBar: new AppBar(
                    centerTitle: true,
                    leading: InkWell(
                      onTap: () {
                                                ...
                                                for (int i = 0;
                                                    i <
                                                        controller
                                                            .imgFiles.length;
                                                    i++) {
                                                  controller.imgFiles[i]
                                                      .isSelect = true;
                                                  controller.selectedList.add(
                                                      controller.imgFiles[i]);
                                                }
                                                controller
                                                    .updateIsSelectDeselectAll(
                                                        true);
                                              } else {
                                                for (int i = 0;
                                                    i <
                  ...
                  bottomNavigationBar: BottomNavigationBar(
                      items: <BottomNavigationBarItem>[
                        ...
                        BottomNavigationBarItem(
                            ...
                            label: 'bottom_bar_popular'.tr,
                            backgroundColor: AppColors.black),
                        BottomNavigationBarItem(
                          icon: Image.asset(
                            AppString.iconImagesPath +
                                "ic_saved_collection.png",
                      ...
                      backgroundColor: AppColors.backgroundColor,
                      currentIndex:
                          commonEditorController.selectedBottomMainIndex,
  ...
  Future<void> changeTitle(
      int index, CommonEditorController commonEditorController) async {
    switch (index) {
      case 0:
        title = "app_bar_title_1".tr;
        break;
      case 1:
        title = "app_bar_title_2".tr;
        break;
      case 2:
        title = "app_bar_title_3".tr;
        break;
    }
  ...
  showExitFromEditor() {
    AwesomeDialog(
        ...
        headerAnimationLoop: true,
        title: 'exit_editor'.tr,
        desc: 'exit_editor_description'.tr,
        btnOkOnPress: () {
          SystemNavigator.pop();
        },
        btnOkColor: Colors.red,
