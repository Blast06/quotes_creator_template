...
class AppColors {
  ...
  static const Color primaryColor = const Color(0xff25D366);

  static const Color primaryDarkColor = const Color(0xFFF05454);
  static const Color backgroundColor = const Color(0xFF0f0f0f);
  static const Color textDisableColor = const Color(0xFF555555);
  static const Color iconDisableColor = const Color(0xFF121212);
  ...
  static const LinearGradient instaBGGradiant = const LinearGradient(
    ...
    colors: <Color>[AppColors.instaBGColor, AppColors.instaBGColor1],
  );
}
