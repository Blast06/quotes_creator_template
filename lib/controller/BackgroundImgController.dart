...
class BackgroundImgController extends GetxController {
  ...
  final CommonEditorController commonEditorController =
  ...
  void apiLogin() async {
    ...
    Future.delayed(Duration(microseconds: 0), () {
      RequestApi request = RequestApi(url: ApiUtils.Thoughts_IMG, body: {});
      request.post().then((value) {
        ...
        if (getBgImageResponse.status == true) {
          if (getBgImageResponse.data != null) {
            ...
            commonEditorController.updateBgImgRatioResponse(
                commonEditorController.getBgImageResponse.data.size.ratio916);

            print("aaaaaaaaaaaaaaaaaa" +
                getBgImageResponse.data.size.ratio32.img[0].img.toString());
            print("aaaaaaaaaaaaaaaaaa" +
                commonEditorController.getBgImageResponse.data.path.toString());
